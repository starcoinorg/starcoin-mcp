...
use starcoin_node_mcp_types::{GetBlockInput, Mode, RuntimeConfig, VmProfile};
use url::Url;

#[tokio::test]
#[ignore = "requires STARCOIN_NODE_MCP_E2E_RPC_URL"]
async fn read_only_smoke_against_live_rpc_endpoint() {
    let rpc_url = env::var("STARCOIN_NODE_MCP_E2E_RPC_URL")
        .expect("STARCOIN_NODE_MCP_E2E_RPC_URL must be set for live smoke tests");
