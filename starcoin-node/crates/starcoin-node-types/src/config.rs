...
#[command(name = "starcoin-node")]
#[command(about = "Chain-facing runtime and CLI for Starcoin nodes")]
pub struct CliArgs {
    #[arg(long)]
    pub config: Option<PathBuf>,
    #[arg(long, env = "STARCOIN_NODE_RPC_ENDPOINT_URL")]
    pub rpc_endpoint_url: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_MODE")]
    pub mode: Option<Mode>,
    #[arg(long, env = "STARCOIN_NODE_VM_PROFILE")]
    pub vm_profile: Option<VmProfile>,
    #[arg(long, env = "STARCOIN_NODE_EXPECTED_CHAIN_ID")]
    pub expected_chain_id: Option<u8>,
    #[arg(long, env = "STARCOIN_NODE_EXPECTED_NETWORK")]
    pub expected_network: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_EXPECTED_GENESIS_HASH")]
    pub expected_genesis_hash: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_REQUIRE_GENESIS_HASH_MATCH")]
    pub require_genesis_hash_match: Option<bool>,
    #[arg(long, env = "STARCOIN_NODE_CONNECT_TIMEOUT_MS")]
    pub connect_timeout_ms: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_REQUEST_TIMEOUT_MS")]
    pub request_timeout_ms: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_STARTUP_PROBE_TIMEOUT_MS")]
    pub startup_probe_timeout_ms: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_RPC_AUTH_TOKEN")]
    pub rpc_auth_token: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_RPC_AUTH_TOKEN_ENV")]
    pub rpc_auth_token_env: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_RPC_HEADERS")]
    pub rpc_headers: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_TLS_SERVER_NAME")]
    pub tls_server_name: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_ALLOWED_RPC_HOSTS")]
    pub allowed_rpc_hosts: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_TLS_PINNED_SPKI_SHA256")]
    pub tls_pinned_spki_sha256: Option<String>,
    #[arg(long, env = "STARCOIN_NODE_ALLOW_INSECURE_REMOTE_TRANSPORT")]
    pub allow_insecure_remote_transport: Option<bool>,
    #[arg(long, env = "STARCOIN_NODE_ALLOW_READ_ONLY_CHAIN_AUTODETECT")]
    pub allow_read_only_chain_autodetect: Option<bool>,
    #[arg(long, env = "STARCOIN_NODE_DEFAULT_EXPIRATION_TTL_SECONDS")]
    pub default_expiration_ttl_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_EXPIRATION_TTL_SECONDS")]
    pub max_expiration_ttl_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_WATCH_POLL_INTERVAL_SECONDS")]
    pub watch_poll_interval_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_WATCH_TIMEOUT_SECONDS")]
    pub watch_timeout_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_HEAD_LAG_SECONDS")]
    pub max_head_lag_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_WARN_HEAD_LAG_SECONDS")]
    pub warn_head_lag_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_ALLOW_SUBMIT_WITHOUT_PRIOR_SIMULATION")]
    pub allow_submit_without_prior_simulation: Option<bool>,
    #[arg(long, env = "STARCOIN_NODE_CHAIN_STATUS_CACHE_TTL_SECONDS")]
    pub chain_status_cache_ttl_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_ABI_CACHE_TTL_SECONDS")]
    pub abi_cache_ttl_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MODULE_CACHE_MAX_ENTRIES")]
    pub module_cache_max_entries: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_DISABLE_DISK_CACHE")]
    pub disable_disk_cache: Option<bool>,
    #[arg(long, env = "STARCOIN_NODE_MAX_SUBMIT_BLOCKING_TIMEOUT_SECONDS")]
    pub max_submit_blocking_timeout_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_WATCH_TIMEOUT_SECONDS")]
    pub max_watch_timeout_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MIN_WATCH_POLL_INTERVAL_SECONDS")]
    pub min_watch_poll_interval_seconds: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_LIST_BLOCKS_COUNT")]
    pub max_list_blocks_count: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_EVENTS_LIMIT")]
    pub max_events_limit: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_ACCOUNT_RESOURCE_LIMIT")]
    pub max_account_resource_limit: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_ACCOUNT_MODULE_LIMIT")]
    pub max_account_module_limit: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_LIST_RESOURCES_SIZE")]
    pub max_list_resources_size: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_LIST_MODULES_SIZE")]
    pub max_list_modules_size: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_PUBLISH_PACKAGE_BYTES")]
    pub max_publish_package_bytes: Option<u64>,
    #[arg(long, env = "STARCOIN_NODE_MAX_CONCURRENT_WATCH_REQUESTS")]
    pub max_concurrent_watch_requests: Option<usize>,
    #[arg(long, env = "STARCOIN_NODE_MAX_INFLIGHT_EXPENSIVE_REQUESTS")]
...
impl RuntimeConfig {
    pub fn load(cli: CliArgs) -> anyhow::Result<Self> {
        ...
        let log_level = cli
            ...
            .or_else(|| env::var("STARCOIN_NODE_LOG_LEVEL").ok())
...
fn default_config_path() -> Option<PathBuf> {
    ...
    let preferred_dir = config_dir.join(default_config_subdir());
    for candidate in [preferred_dir.join("node-cli.toml")] {
        if candidate.exists() {
            return Some(candidate);
        }
    }

    Some(preferred_dir.join("node-cli.toml"))
}

fn env_config_path() -> Option<PathBuf> {
    for env_name in ["STARCOIN_NODE_CLI_CONFIG"] {
...
mod tests {
    ...
    fn transaction_mode_requires_chain_pins() {
        let config_path = std::env::temp_dir().join(format!(
            "starcoin-node-missing-{}-{}.toml",
            std::process::id(),
            std::thread::current().name().unwrap_or("unnamed")
        ));
        let _ = std::fs::remove_file(&config_path);
        let cli = CliArgs::parse_from(vec![
            "starcoin-node".to_owned(),
            "--config".to_owned(),
